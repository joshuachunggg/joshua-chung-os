...
interface MacOSDockProps {
  ...
  openApps?: string[];
  className?: string;
  /** Extra content rendered inside the dock pill after the app icons
   *  (used by this OS for minimized-window tiles). Receives the base icon size. */
  trailing?: (iconSize: number) => React.ReactNode;
}
...
const MacOSDock: React.FC<MacOSDockProps> = ({
  ...
  return (
    ...
    >
      <div className="flex items-end" style={{ gap: `${baseSpacing}px` }}>
        <div
          className="relative"
          style={{
        ...
        >
          {apps.map((app, index) => {
            ...
            return (
              ...
              >
                {/* macOS-style app name label above the icon */}
                {hoveredIndex === index && (
                  <div
                    ...
                    style={{
                      ...
                      marginBottom: Math.max(8, baseIconSize * 0.14),
                      padding: "3px 11px",
                      borderRadius: 8,
                      fontSize: 13.5,
                      fontWeight: 500,
                ...
                {openApps.includes(app.id) && (
                  <div
                    className="absolute"
                    style={{
                      bottom: `${-Math.max(6, baseIconSize * 0.11)}px`,
                      left: '50%',
                      transform: 'translateX(-50%)',
